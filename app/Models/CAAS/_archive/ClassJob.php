...
class ClassJob extends _LibraBasic
{
	...
	public function en_abbr() { return $this->hasOne('App\Models\CAAS\Translations', 'id', 'abbr_en'); }
	public function ja_abbr() { return $this->hasOne('App\Models\CAAS\Translations', 'id', 'abbr_ja'); }
	public function fr_abbr() { return $this->hasOne('App\Models\CAAS\Translations', 'id', 'abbr_fr'); }
	public function de_abbr() { return $this->hasOne('App\Models\CAAS\Translations', 'id', 'abbr_de'); }
