...
@section('content')
	{!! Form::open(['url' => '/career/producer', 'class' => 'form-horizontal']) !!}
	...
	{!! Form::open(['url' => '/career/receiver', 'class' => 'form-horizontal']) !!}
		<div class='panel panel-default'>
			<div class='panel-heading'>
	...
	{!! Form::open(['url' => '/career/gathering', 'class' => 'form-horizontal']) !!}
		<div class='panel panel-default'>
			<div class='panel-heading'>
