<div class='alert alert-warning support-us collapse' role='alert'>
	<div class='alert-header'>
		<button type="button" class="btn btn-link pull-right alert-link padding-0 hide-btn">Hide</button>
		<h4>FFXIVCrafting Needs Your Support</h4>
	</div>
